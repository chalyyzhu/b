...
#cl = LineClient()
cl = LineClient(authToken='ECXLodyyU0BZFQz5sNd9.cYtIcXhjs9QvlOPOyb5coq.BOlv7/rzUiTY65Aj46/aeeu5VMxhF15Phuaq8cLO8Qc=')   #PH-13
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 BLaͥץers_ID 」\n")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               Setmain["namecreator"] = "BLaͥץers_ID™"
...
#===========Hiburan============#
                        ...
                        elif cmd == "spamcall"or text.lower() == '📞':
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
